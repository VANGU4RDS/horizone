  ...
  return (
    <>
        <div className='flex flex-col items-center w-full h-full bg-black'>
            <div className='flex justify-center bg-white w-full h-[20%]'>
                <img className='w-full h-full' src="/HoriZone.png" alt="Horizone" />
            </div>
            <div className='flex flex-col items-center justify-evenly w-full h-full bg-cream-200 px-2'>
                ...
                <div className='flex flex-col items-start bg-cream-400 w-full rounded-md px-2 py-3'>
                    <ul className='w-full'>
                ...
                <div className='flex flex-col items-center bg-cream-400 w-full rounded-md px-2 py-3'>
                    <img className='w-[50%]' src="Ori.png" alt="" />
                    <h1 className='text-center text-xs font-sans'>Need Support?</h1>
